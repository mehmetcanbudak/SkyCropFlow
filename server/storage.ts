  ...
  private async seedData() {
    ...
    const categoryData = [
      {
        ...
        slug: "leafy-greens",
        description:
          "Fresh lettuce, spinach, and kale varieties that stay alive until consumption",
        color: "primary",
      },
      {
        name: "fresh herbs",
        slug: "fresh-herbs",
        description:
          "Aromatic basil, cilantro, and parsley grown in optimal conditions",
        color: "secondary",
      },
      {
        name: "microgreens",
    ...
    const productData = [
      {
        ...
        price: 2500,
        description:
          "Fresh butterhead lettuce grown in our vertical farming facility. These living vegetables continue growing until consumption, ensuring maximum freshness and nutrition.",
        flavor: "crisp, fresh, mild",
        category: "leafy-greens",
        imageUrl:
          "https://images.unsplash.com/photo-1576045057995-568f588f82fb?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600",
        isNewArrival: false,
        isBestseller: true,
        featured: true,
        inStock: true,
      },
      {
        ...
        price: 1800,
        description:
          "Aromatic sweet basil grown in controlled environment conditions.",
        flavor: "aromatic, sweet, and fresh",
        category: "fresh-herbs",
        imageUrl:
          "https://images.unsplash.com/photo-1618164436241-4473940d1f5c?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600",
        isNewArrival: true,
        isBestseller: false,
        featured: false,
        inStock: true,
      },
      {
        ...
        price: 2200,
        description:
          "Nutrient-rich kale grown with vertical farming technology.",
        flavor: "earthy, nutritious, crisp",
        category: "leafy-greens",
        imageUrl:
          "https://images.unsplash.com/photo-1515023115689-589c33041d3c?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600",
        isNewArrival: true,
        isBestseller: false,
        featured: false,
        inStock: true,
      },
      {
        ...
        category: "leafy-greens",
        imageUrl:
          "https://images.unsplash.com/photo-1540420773420-3366772f4999?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600",
        isNewArrival: true,
        isBestseller: false,
        featured: false,
        inStock: true,
      ...
      },
      {
        ...
        price: 3500,
        description:
          "Mixed fresh herbs for cooking - basil, parsley, cilantro.",
        flavor: "Mixed fresh herbs for cooking",
        category: "fresh-herbs",
        imageUrl:
          "https://images.unsplash.com/photo-1566195992011-5f6b21e539aa?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600",
        isNewArrival: false,
        isBestseller: true,
        featured: false,
        inStock: true,
      },
      {
        ...
        originalPrice: 9000,
        description:
          "Complete vegetable variety pack with seasonal selections.",
        flavor: "Complete vegetable variety pack",
        category: "specialty-mix",
        imageUrl:
          "https://images.unsplash.com/photo-1622206151226-18ca2c9ab4a1?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600",
        isNewArrival: false,
        isBestseller: true,
        featured: false,
        inStock: true,
    ...
    const articleData = [
      ...
      },
      {
        ...
        excerpt:
          "Wageningen University ve Araştırma Merkezi (WUR) tarafından düzenlenen Dikey Tarım programına katılan Kurucu Ortağımız Gamze Çapkınoğlu edindiği değerli bilgilerle dikey tarım alanındaki vizyonumuzu derinleştirdi.",
        content:
          "Our participation in the Wageningen University vertical farming program has provided valuable insights into advanced agricultural technologies and sustainable farming practices.",
        imageUrl:
          "https://images.unsplash.com/photo-1530836369250-ef72a3f5cda8?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600",
      ...
      },
      {
        ...
        excerpt:
          "Tesisimizde bir araya geldiğimiz Anadolu Ajansı ekibi ile Skycrops'un hikayesini ve dikey tarım alanındaki çalışmalarımızı konuştuk. Kendilerine ziyaretleri ve ilgileri için teşekkür ederiz.",
        content:
          "Anadolu Agency's visit to our facility showcased our cutting-edge vertical farming technology and sustainable agricultural practices to a wider audience.",
        imageUrl:
          "https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600",
      ...
      },
      {
        ...
        excerpt:
          "Tekirdağ Valiliği İl Tarım ve Orman Müdürlüğü'ne tesisimize verdikleri destek ve 8 Mart Dünya Kadınlar Günü'nü kutlamaları için teşekkür ederiz.",
        content:
          "Recognition from the Provincial Directorate of Agriculture on International Women's Day highlights our commitment to supporting women in agricultural innovation.",
        imageUrl:
      ...
      },
      {
        ...
        excerpt:
          "Exploring how vertical farming technology is revolutionizing food production while reducing environmental impact. Our innovative approach to growing fresh vegetables year-round.",
        content:
          "Vertical farming represents a paradigm shift in agriculture, offering solutions to climate change, water scarcity, and urbanization challenges.",
        imageUrl:
          "https://images.unsplash.com/photo-1530587191325-3db32d826c18?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600",
      ...
      },
      {
        ...
        excerpt:
          "Take a behind-the-scenes look at how we grow our living vegetables using advanced hydroponic systems, LED lighting, and climate control technology.",
        content:
          "Our state-of-the-art facility uses the latest in agricultural technology to create optimal growing conditions for our vegetables.",
        imageUrl:
          "https://images.unsplash.com/photo-1542838132-92c53300491e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600",
      ...
      },
      {
        ...
        excerpt:
          "Understanding the nutritional and freshness benefits of vegetables that continue growing until consumption. Why living vegetables are better for your health.",
        content:
          "Living vegetables maintain their nutritional value and continue photosynthesis until the moment of consumption, providing superior freshness and taste.",
        imageUrl:
      ...
      },
      {
        ...
        excerpt:
          "How our vertical farming system uses 97% less water than traditional farming methods while maintaining optimal plant nutrition and growth.",
        content:
          "Water conservation is crucial for sustainable agriculture. Our closed-loop hydroponic systems maximize efficiency while minimizing waste.",
        imageUrl:
