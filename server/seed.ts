  ...
  try {
    ...
    const categoryData = [
      ...
      },
      {
        ...
        slug: "yesillikler",
        description:
          "Fresh, crisp leafy vegetables grown in our vertical farms",
        color: "#22c55e",
      },
      {
        name: "Baharatlar",
    ...
    const productData = [
      ...
      },
      {
        ...
        originalPrice: null,
        description:
          "Aromatic basil leaves with intense flavor, grown without soil using advanced hydroponic systems.",
        flavor: null,
        category: "baharatlar",
        imageUrl:
      ...
      },
      {
        ...
        originalPrice: null,
        description:
          "Nutrient-rich spinach leaves grown in our vertical farming towers, perfect for healthy meals.",
        flavor: null,
        category: "yesillikler",
        imageUrl:
      ...
      },
      {
        ...
        originalPrice: null,
        description:
          "Peppery arugula with a distinctive taste, grown using sustainable vertical farming methods.",
        flavor: null,
        category: "yesillikler",
        imageUrl:
      ...
      },
      {
        ...
        originalPrice: null,
        description:
          "A colorful mix of microgreens including radish, mustard, and pea shoots.",
        flavor: null,
        category: "fideler",
        imageUrl:
      ...
      },
      {
        ...
        originalPrice: null,
        description:
          "Fresh cilantro leaves with bright, citrusy flavor, grown in our controlled environment facility.",
        flavor: null,
        category: "baharatlar",
        imageUrl:
          "https://images.unsplash.com/photo-1584279186917-7dc15fc75e26?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600",
        featured: false,
        isBestseller: true,
        inStock: true,
        isNewArrival: false,
